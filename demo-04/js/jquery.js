...
(function(z, v) {
  ...
  c.fn = c.prototype = {
    ...
    pushStack: function(a, b, d) {
      ...
      if (b === "find")
        a.selector = this.selector + (this.selector
          ? " "
          : "") + d;
      else if (b)
        ...
        for (i in e) {
          ...
          if (a !== n)
            if (f && n && (c.isPlainObject(n) || c.isArray(n))) {
              j = j && (c.isPlainObject(j) || c.isArray(j))
                ? j
                : c.isArray(n)
                  ? []
                  : {};
  ...
  c.extend({
    ...
    attr: function(a, b, d, f) {
      ...
      if (a.nodeType === 1) {
        ...
        a = !c.support.hrefNormalized && f && i
          ? a.getAttribute(b, 2)
          : a.getAttribute(b);
        return a === null
          ? v
  ...
  if (!c.support.submitBubbles)
    c.event.special.submit = {
      ...
      remove: function(a, b) {
        c.event.remove(this, "click.specialSubmit" + (b
          ? "." + b.guid
          : ""));
        c.event.remove(this, "keypress.specialSubmit" + (b
          ? "." + b.guid
          : ""))
      }
    };
  if (!c.support.changeBubbles) {
    ...
    c.event.special.change = {
      ...
      remove: function(a, b) {
        for (var d in T)
          c.event.remove(this, d + ".specialChange" + (b
            ? "." + b.guid
            : ""), T[d]);
        return da.test(this.nodeName)
      }
        ...
        i = i === "focus"
          ...
          : i === "blur"
            ...
            : i === "hover"
              ...
              : i;
        b === "live"
          ? c(this.context).bind(oa(i, this.selector), {
            data: f,
            selector: this.selector,
            live: i
          }, e)
          : c(this.context).unbind(oa(i, this.selector), e
            ? {
    ...
    var o = function(g, h, k, l) {
      ...
      if (p.length > 1 && s.exec(g))
        if (p.length === 2 && m.relative[p[0]])
          ...
          for (t = m.relative[p[0]]
            ? [h]
            : o(p.shift(), h); p.length;) {
            g = p.shift();
            if (m.relative[g])
              g += p.shift();
            t = fa(g, t)
        ...
        if (h) {
          u = l
            ...
            : o.find(p.pop(), p.length === 1 && (p[0] === "~" || p[0] === "+") && h.parentNode
              ? h.parentNode
              : h, M);
          t = u.expr
            ? o.filter(u.expr, u.set)
            : u.set;
          if (p.length > 0)
            y = A(t);
          else
          ...
          "+": function(g, h) {
            ...
            for (var q = g.length, p; l < q; l++)
              if (p = g[l]) {
                ...
                ;
                g[l] = k || p && p.nodeName.toLowerCase() === h
                  ? p || false
                  : p === h
              }
            k && o.filter(h, g, true)
        ...
        m.find.ID = function(l, q, p) {
          if (typeof q.getElementById !== "undefined" && !p)
            return (q = q.getElementById(l[1]))
              ? q.id === l[1] || typeof q.getAttributeNode !== "undefined" && q.getAttributeNode("id").nodeValue === l[1]
                ? [q]
                : v
              : []
          };
  ...
  c.fn.extend({
      ...
      if (c.isArray(a)) {
        ...
        if (f && a.length) {
          ...
          for (var n = a.length; e < n; e++) {
            j = a[e];
            i[j] || (i[j] = c.expr.match.POS.test(j)
              ? c(j, b || this.context)
              : j)
          }
    ...
    add: function(a, b) {
      ...
      return this.pushStack(pa(a[0]) || pa(b[0])
        ? b
        : c.unique(b))
    },
    andSelf: function() {
    ...
    domManip: function(a, b, d) {
      function f(s) {
        return c.nodeName(s, "table")
          ? s.getElementsByTagName("tbody")[0] || s.appendChild(s.ownerDocument.createElement("tbody"))
          : s
      }
      var e,
        i,
      ...
      if (this[0]) {
        ...
        if (i = e.fragment.firstChild) {
          ...
          for (var o = 0, m = this.length; o < m; o++)
            d.call(b
              ? f(this[o], i)
              : this[o], e.cacheable || this.length > 1 || o > 0
      ...
      if (d)
        for (a = 0; e[a]; a++)
          if (f && c.nodeName(e[a], "script") && (!e[a].type || e[a].type.toLowerCase() === "text/javascript"))
            f.push(e[a].parentNode
              ? e[a].parentNode.removeChild(e[a])
              : e[a]);
          else {
            e[a].nodeType === 1 && e.splice.apply(e, [
              a + 1,
              0
            ].concat(c.makeArray(e[a].getElementsByTagName("script"))));
            d.appendChild(e[a])
          }
        return e
    },
  ...
  c.extend({
    ...
    ajax: function(a) {
      ...
      if (e.dataType === "jsonp") {
        if (m === "GET")
          N.test(e.url) || (e.url += (ja.test(e.url)
            ? "&"
            : "?") + (e.jsonp || "callback") + "=?");
      ...
      if (w) {
        ...
        try {
          ...
          w.setRequestHeader("Accept", e.dataType && e.accepts[e.dataType]
      ...
      function d(j, n) {
        if (c.isArray(n))
          c.each(n, function(o, m) {
            b
              ? f(j, m)
              : d(j + "[" + (typeof m === "object" || c.isArray(m)
                ? o
                : "") + "]", m)
          });
        else
        ...
        return (i = ua(e))
          ? "pageXOffset" in i
            ? i[a
                ? "pageYOffset"
                : "pageXOffset"]
            : c.support.boxModel && i.document.documentElement[d] || i.document.body[d]
          : e[d]
      }
  });
  c.each([
