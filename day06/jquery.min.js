...
!function(a, b) {
  ...
  r.extend({
    ...
    proxy: function(a, b) {
      ...
      r.isFunction(a)
        ? (d = f.call(arguments, 2), e = function() {
  ...
  r.extend({
    queue: function(a, b, c) {
      var d;
      return a
        ? (b = (b || "fx") + "queue", d = V.get(a, b), c && (!d || r.isArray(c)
    ...
    return this instanceof r.Event
      ? (a && a.type
        ? (this.originalEvent = a, this.type = a.type, this.isDefaultPrevented = a.defaultPrevented || void 0 === a.defaultPrevented && a.returnValue === !1
          ? ta
          : ua, this.target = a.target && 3 === a.target.nodeType
          ? a.target.parentNode
    ...
    if (m && (e = oa(b, a[0].ownerDocument, !1, a, d), f = e.firstChild, 1 === e.childNodes.length && (e = f), f || d)) {
      ...
      if (i)
        for (k = h[h.length - 1].ownerDocument, r.map(h, Ea), l = 0; i > l; l++)
          j = h[l],
          ja.test(j.type || "") && !V.access(j, "globalEval") && r.contains(k, j) && (j.src
      ...
      if (a && 3 !== a.nodeType && 8 !== a.nodeType && a.style) {
        ...
        void 0 === c
          ? g && "get" in g && void 0 !== (e = g.get(a, !1, d))
            ? e
            : i[b]
          : (f = typeof c, "string" === f && (e = _.exec(c)) && e[1] && (c = da(a, b, e), f = "number"), null != c && c === c && ("number" === f && (c += e && e[3] || (r.cssNumber[h]
            ? ""
  ...
  r.each([
    ...
    r.cssHooks[b] = {
      get: function(a, c, d) {
        return c
          ? !Oa.test(r.css(a, "display")) || a.getClientRects().length && a.getBoundingClientRect().width
            ? Wa(a, b, d)
            : ca(a, Pa, function() {
              return Wa(a, b, d)
            })
  ...
  Xa.prototype = {
    ...
    run: function(a) {
      ...
      c && c.set
        ? c.set(this)
        : Xa.propHooks._default.set(this),
      this
    }
  },
  ...
  function eb(a, b, c) {
    ...
    if (i = !r.isEmptyObject(b), i || !r.isEmptyObject(n)) {
      l && 1 === a.nodeType && (c.overflow = [
        ...
        ? k = j
        : (ga([a], !0), j = a.style.display || j, k = r.css(a, "display"), ga([a]))), ("inline" === k || "inline-block" === k && null != j) && "none" === r.css(a, "float") && (i || (m.done(function() {
        o.display = j
      ...
      for (d in n)
        i || (q
          ...
          : q = V.access(a, "fxshow", {display: j}), f && (q.hidden = !p), p && ga([a], !0), m.done(function() {
          p || ga([a]),
          V.remove(a, "fxshow");
          for (d in n)
            r.style(a, d, n[d])
  ...
  r.Animation = r.extend(gb, {
    ...
    prefilter: function(a, b) {
      b
        ? gb.prefilters.unshift(a)
        : gb.prefilters.push(a)
    }
  }),
  ...
  r.each(r.expr.match.bool.source.match(/\w+/g), function(a, b) {
    ...
    ib[b] = function(a, b, d) {
      var e,
        f,
        g = b.toLowerCase();
      return d || (f = ib[g], ib[g] = e, e = null != c(a, b, d)
        ? g
        : null, ib[g] = f),
      e
    }
        ...
        : r.isFunction(a)
          ...
          : this.each(function() {
            ...
            if ("string" === c) {
              ...
              void 0 !== a && "boolean" !== c || (b = mb(this), b && V.set(this, "__className__", b), this.setAttribute && this.setAttribute("class", b || a === !1
                ? ""
  ...
  r.extend({
    valHooks: {
      ...
      select: {
        get: function(a) {
          for (var b, c, d = a.options, e = a.selectedIndex, f = "select-one" === a.type, g = f
            ? null
            : [], h = f
            ? e + 1
            : d.length, i = 0 > e
    ...
    ajax: function(b, c) {
      ...
      o.hasContent
        ...
        : (n = o.url.slice(f.length), o.data && (f += (sb.test(f)
          ? "&"
          : "?") + o.data, delete o.data), o.cache === !1 && (f = f.replace(Ab, ""), n = (sb.test(f)
          ? "&"
          : "?") + "_=" + rb++ + n), o.url = f + n),
      ...
      function A(b, c, d, h) {
        ...
        k || (k = !0, i && a.clearTimeout(i), e = void 0, g = h || "", y.readyState = b > 0
          ? 4
          : 0, j = b >= 200 && 300 > b || 304 === b, d && (v = Mb(o, y, d)), v = Nb(o, v, y, j), j
          ...
          : (n = x, !b && x || (x = "error", 0 > b && (b = 0))), y.status = b, y.statusText = (c || x) + "", j
